...
client.on('ready', () => {
 client.user.setActivity(`With ${client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Members`, { type: 'WATCHING' }) //you can replace "#"
...
//===========================================================\\
const pollSchema = require("../module/poll.js");
const {
    ChartJSNodeCanvas,
    ChartConfiguration,
